...
const Cartpage = () => {
    ...
    const totalPrice = () => {
        try {
            ...
            return total.toLocaleString("em-US", {
                style: "currency",
                currency: "USD",
            })
        }
                                ...
                                cart?.map(p => (
                                    <div className='row card  flex-row'>
                                        <div className='col-md-4'>
                                            <img src={`http://localhost:8080/api/v1/product/product-photo/${p._id}`} className="card-img-top" alt={p.name} width='100px' height={"100px"} />
                                        </div>
                                        <div className='col-md-4'>
                                            <p>{p.name}</p>
                                        ...
                                        <div className="col-md-4 cart-remove-btn">
                                            <button className='btn btn-danger' on onClick={() => removeCartItem(p._id)}>Remove</button>
                                        </div>
